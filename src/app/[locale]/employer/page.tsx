...
const TESTIMONIALS = [
  {
    ...
    quote: "We hired 12 delivery boys in one week. Job Ready is the fastest way to find blue-collar workers.",
    rating: 5,
  },
  {
    name: "Priya Sharma",
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a3461] mb-3">Why employers choose Job Ready</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-[#1a3461] to-[#1e4080]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white/70 mb-8 leading-relaxed">
            Join 5,000+ companies already hiring on Job Ready. Post your first job free — no subscription needed.
          </p>
