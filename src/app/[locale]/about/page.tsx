    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Jobs24India was born from a simple observation: India has hundreds of millions of skilled,
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                We set out to change that. Jobs24India is built ground-up for India's frontline workforce:
      ...
      <section className="py-14 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-50 rounded-2xl border border-gray-100 p-6 text-sm text-gray-600 space-y-2">
            ...
            <p><strong className="text-gray-800">Product:</strong> Jobs24India (jobs24india.com)</p>
            <p><strong className="text-gray-800">Registered in:</strong> India</p>
            <p><strong className="text-gray-800">Contact:</strong>{" "}
              <a href="mailto:support@jobs24india.com" className="text-blue-700 hover:underline">support@jobs24india.com</a>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-[#1a3461] text-white text-center">
        <div className="max-w-xl mx-auto px-4">
          ...
          <p className="text-white/70 text-sm mb-6">Join thousands of workers who found their dream job on Jobs24India.</p>
