...
function LoginPageContent() {
    ...
    try {
      ...
      setError(
        msg.includes("invalid-phone-number")
          ...
          ? "Too many OTP requests for this number. Please wait ~1 hour before trying again."
    ...
    try {
      ...
      setError(
        msg.includes("already registered as")
          ? msg   // cross-role error from our API — show it verbatim
          : msg.includes("invalid-verification-code")
          ? "Incorrect OTP. Please try again."
          : msg.includes("too-many-requests")
          ? "Too many attempts. Please wait ~1 hour and try again."
  ...
  async function googleSignIn(googleRole: "SEEKER" | "EMPLOYER" = "EMPLOYER") {
    setError("")
    setLoading(true)
    try {
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          ...
          {step === "phone" && (
            <form onSubmit={sendOtp} className="flex flex-col gap-4">
              ...
              {/* Google sign-in option for seekers */}
              {role === "seeker" && (
                <>
                  ...
                  <button
                    type="button"
                    onClick={() => googleSignIn("SEEKER")}
                    disabled={loading}
                    className="w-full py-3 rounded-xl bg-white border-2 border-gray-200 text-gray-700 font-semibold text-sm hover:border-orange-400 hover:bg-orange-50 transition-all disabled:opacity-60 flex items-center justify-center gap-3"
                  >
                    {loading ? (
          ...
          {step === "otp" && (
            <form onSubmit={verifyOtp} className="flex flex-col gap-4">
              <div className="text-center mb-1">
                ...
                <p className="text-xs text-gray-400 mt-0.5">OTP is valid for <strong>10 minutes</strong></p>
              </div>
              <div>
